...
import { TestimonialsType, testimonials } from "../../../shared/const/content";

type FeedbackCardProps = TestimonialsType & {index: number}

const FeedbackCard = (props: FeedbackCardProps): JSX.Element => {
  const {index, name, testimonial, designation, image, company} = props;
