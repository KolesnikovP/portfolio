...
import { projects } from '../../../shared/const/content';
...
const ProjectCard = (props: PostCardProps) => {
  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Folowing projects showcases my skills and experience through real-world examples of my work. Each projects is briefly described.
        </motion.p>
      </div>
